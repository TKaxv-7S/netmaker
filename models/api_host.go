...
type ApiHost struct {
	...
	ForbidDetectionHosts []string `json:"forbid_detection_hosts" yaml:"forbid_detection_hosts"`
...
func (h *Host) ConvertNMHostToAPI() *ApiHost {
	...
	a.ForbidDetectionHosts = h.ForbidDetectionHosts
...
func (a *ApiHost) ConvertAPIHostToNMHost(currentHost *Host) *Host {
	...
	h.ForbidDetectionHosts = a.ForbidDetectionHosts
